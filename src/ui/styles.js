...
export const MAP_STYLE = Object.freeze({
  ...
  HYDRO_LINE_ALPHA: 0.85,
  HYDRO_LINE_HIGH_ZOOM_ALPHA: 0.98,
  HYDRO_LINE_SCREEN_WIDTH: 1.9,
  HYDRO_LINE_EMPHASIS_SCREEN_WIDTH: 3.4,
  HYDRO_LINE_START_MULTIPLIER: 1.5,
  HYDRO_LINE_FULL_MULTIPLIER: 5.5,
